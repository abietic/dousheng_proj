...
var PublishVideoResponse_BaseResp_DEFAULT *base.BaseResponse

func (p *PublishVideoResponse) GetBaseResp() (v *base.BaseResponse) {
	if !p.IsSetBaseResp() {
...
func (p *PublishVideoResponse) SetBaseResp(val *base.BaseResponse) {
	p.BaseResp = val
}
...
func (p *PublishVideoResponse) Field2DeepEqual(src *base.BaseResponse) bool {
...
var ListVideosResponse_BaseResp_DEFAULT *base.BaseResponse

func (p *ListVideosResponse) GetBaseResp() (v *base.BaseResponse) {
	if !p.IsSetBaseResp() {
...
func (p *ListVideosResponse) SetBaseResp(val *base.BaseResponse) {
	p.BaseResp = val
}
...
func (p *ListVideosResponse) Field2DeepEqual(src *base.BaseResponse) bool {
